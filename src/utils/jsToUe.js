...
"object" != typeof ue && (ue = {}), uuidv4 = function () {
    ...
    return "object" != typeof ue.interface || "function" != typeof ue.interface.synccallue ? (ue.interface = {}, function (t, e, n, o) {
        ...
        // ,"object" == typeof history && "function" == typeof history.pushState ? (history.pushState({}, "", "#" + i), history.pushState({}, "", "#" + encodeURIComponent("[]"))) : (document.location.hash = i, document.location.hash = encodeURIComponent("[]"))
        )
